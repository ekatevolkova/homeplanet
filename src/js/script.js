...
storyTimeline
    ...
    .to("section.scene img", { x: "0vh", duration: 15, ease: "linear" }, "startScene")
    .addLabel("endScene")
...
const eyeballs = document.querySelectorAll("path#ball_1, path#ball_2, path#ball_3, path#ball_4, path#ball_5, path#ball_6")

eyesTimeline
    .set(eyeballs, { y: 0 })
    .to(eyeballs, { y: 7, duration: 0.25, delay: 2, stagger: 0.25 })
    .to(eyeballs, { y: 0, duration: 0.25, delay: 3 })


const hatTimelime = gsap.timeline({
    repeat: -1, 
    repeatDelay: 4
})
...
// const arms = document.querySelectorAll("g#left-arm, g#right-arm")


// armTimeline
//     .set(arms, { rotation: 0 })
//     .to(arms, { rotation: 30, duration: 0.5, stagger: 0.5})
//     .to(arms, { rotation: -30, duration: 0.5, delay: 1, stagger: 0.5})
//     .to(arms, { rotation: 0, duration: 0.25, delay: 2})
...
rightArmTimeline
    ...
    .to(rightArm, { rotation: -20, duration: 0.25, delay: 4} )
